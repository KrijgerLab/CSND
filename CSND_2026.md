...
**Aim**: Aim of this project is to experimentally validate functional relevance of a risk variant (rs2888142) and identify the affected gene. Once that is done, we will design a CRIPSR-Cas9 guide-RNA to be used for genome editing and delete the affected regulatory element. Finally, we will design primers to be used for cDNA qPCR experiments with the aim of checking whether this modification would cause any of the candidate target genes to be up or downregulated in the K562 cell line. 
