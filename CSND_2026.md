...
**Q3.** Which histone modification is classically indicative of active enhancers? 
...
**Q4.** Is rs9749546 inside an active enhancer in the K562 cell line?

*Hints:*
- You can load the relevant ChIP-seq track and look at the coverage of this mark
- You can use “Track search” button on the UCSC Genome Browser for this
- Once you click on the “Track search” button, a new page will load. There, you will see a search box. Use “K562 <name of histone modification>”.
- Choose the track that is described as: “K562 Cells from ENCODE”
- Put the check mark beside this track. Make sure no other tracks are checked.
- Set “Visibility” to “full” and click on “View in Browser”
...
- Adjust the zoom of the browser to see the variant as well as the histone mark coverage related to the variant.
...
- You can use a threshold of an R^2 higher than 0.2 to identify all SNPs that are in LD with the variant of interest.
- If you hover over a SNP in the plot, you see the distance from the index SNP.

**Q7.** Identify the coordinates of the potentially affected enhancer(s). Simply take a screenshot of the ChIP-seq track and annotate the regions that you think are related to the enhancer (for example using multiple hollow “rectangle” shape in the PowerPoint).
