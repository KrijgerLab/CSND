...
**Background**: Let us assume that rs2888142, a SNP (single nucleotide polymorphism, has been associated with sickle cell anemia in a GWAS (genome wide association study) in Nigerian individuals.
...
As seen in **Q2**, rs2888142 is in a non-coding part of the genome. As no gene is directly hit with this variant, the functional impact of this variant is therefore not immediately clear to us. We hypothesize that this region may harbor an enhancer that influences the expression of its surrounding genes. 
...
**Q4.** Is rs2888142 inside an active enhancer in the K562 cell line?
...
______________ tot hier herschreven op 19-12-2025 door JvB ____________
