...
- In case a screenshot (i.e., “print screen”) is requested, simply paste the picture into a slide in your presentation. 
- In case you are asked to take a screenshot of a webpage, but the webpage is larger than a single page, you can take the screenshot of the most relevant part of the page. There is no need to take a screenshot for each page.

**Aim**: To experimentally validate functional relevance of a genetic risk variant (rs2888142) and identify the likely affected gene.

**--------------------------------**

**Background**: Let’s assume that a variant called “rs2888142” is identified in a GWAS study to be related to a blood disease (for example leukemia). 
...
**Q2.** What is the chromosomal coordinate of rs2888142 in the human genome? Which genes are surrounding this variant?
...
- Next, we would like to find our variant of interest. On the top center of the page, there is a search box which says: “gene, chromosome range, …”. There, you can search for the variant of interest.
- On the right side of the opened page, you will see many links pointing to the same variant (across different databases) or a similar variant across different species.
